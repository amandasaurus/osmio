...
fn main() {
    ...
    for _ in pbf_reader.objects() {
        if num_objects % 1_000 == 0  {
            ...
            if duration.as_millis() > 1_000 {
                ...
                println!("Processed {} objects so far. Total time {} s. {} objects/sec", num_objects.separated_string(), duration_sec, ((num_objects as f64)/duration_sec).separated_string_with_fixed_place(3));
                last_print = now;
            }
        }
        num_objects += 1;
    ...
    println!("\nProcessed {} objects in {} s. {} objects/sec", num_objects.separated_string(), duration_sec, ((num_objects as f64)/duration_sec).separated_string_with_fixed_place(3));
